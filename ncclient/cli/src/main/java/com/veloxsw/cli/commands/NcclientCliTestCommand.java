 ...
 */
package com.veloxsw.cli.commands;
...
public class NcclientCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(NcclientCliTestCommand.class);
    protected final NcclientCliCommands service;

    public NcclientCliTestCommand(final NcclientCliCommands service) {
